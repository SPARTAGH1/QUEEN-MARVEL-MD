...
global.channelLink = "https://whatsapp.com/channel/0029VbB7Tsa6WaKgDuGsnO1u";
global.ytch = "TIFE TECH";
...
async function handleGroupParticipantUpdate(sock, update) {
  try {
    ...
    if (action === "add") {
      ...
      const channelId =
        welcomeData?.channelId || "0029VbB7Tsa6WaKgDuGsnO1u@newsletter";
    ...
    if (action === "remove") {
      ...
      const channelId =
        goodbyeData?.channelId || "0029VbB7Tsa6WaKgDuGsnO1u@newsletter";
